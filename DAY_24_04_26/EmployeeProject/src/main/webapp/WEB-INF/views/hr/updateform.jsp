...
<tr>
	<th>EMPLOYEE_ID</th>
	<td>
		<input type="number" name="employeeId" value="${emp.employeeId}" readonly>
	</td>
</tr>
<tr>
	<th>FIRST_NAME</th>
...
<tr>
	<th>PHONE_NUMBER</th>
	<td>
		<input type="text" name="phoneNumber" value="${emp.phoneNumber}">
	</td>
</tr>
<tr>
	<th>HIRE_DATE</th>
...
<tr>
	...
	<td>
		<input type="number" name="commissionPct" value="${emp.commissionPct}"
	...
	<td>
		...
		<c:forEach var="manager" items="${managerList}">
			<option value="${manager.managerId}"
				<%-- <c:if test="${emp.managerId == managerId}">selected</c:if> --%>
